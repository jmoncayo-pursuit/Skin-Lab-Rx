...
export const SKIN_CONCERNS: SkinConcern[] = [
  ...
  { key: 'dark_circle_v2', label: 'Dark Circles', icon: '👁️', description: 'Under-eye discoloration', color: '#8B9BC4' },
  { key: 'age_spot', label: 'Dark Spots', icon: '◉', description: 'Hyperpigmentation', color: '#B09070' },
  { key: 'radiance', label: 'Radiance', icon: '☀️', description: 'Dullness & lack of glow', color: '#C4B87B' },
  { key: 'firmness', label: 'Firmness', icon: '🔷', description: 'Loss of elasticity', color: '#7BA4C4' },
